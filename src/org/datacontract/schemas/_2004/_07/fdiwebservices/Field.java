 ...
 *         &lt;element name="IdNum" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
...
public class Field {
    ...
    @XmlElementRef(name = "Length", namespace = "http://schemas.datacontract.org/2004/07/FDIWebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<String> length;
    @XmlElementRef(name = "Type", namespace = "http://schemas.datacontract.org/2004/07/FDIWebServices", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public void setIdNum(Integer value) {
        this.idNum = value;
    }
