 ...
 *         &lt;element name="PagingN" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetDataSetChanges")
public class GetDataSetChanges {
    ...
    @XmlElementRef(name = "DataIstanza", namespace = "http://webservices.farmadati.it", type = JAXBElement.class, required = false)
    ...
    @XmlElement(name = "PagingN")
    protected Integer pagingN;
    ...
    /**
     * Gets the value of the pagingN property.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
     *     
     */
    public Integer getPagingN() {
        return pagingN;
    }

    /**
     * Sets the value of the pagingN property.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setPagingN(Integer value) {
        this.pagingN = value;
    }
